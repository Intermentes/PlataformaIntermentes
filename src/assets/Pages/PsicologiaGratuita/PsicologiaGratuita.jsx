                ...
                <div className={styles.ContainerOngs}>
                    ...
                    <div className={styles.BoxOng}>
                        ...
                        <div className={styles.BoxDescriptionOng}>
                            ...
                            <a href="https://ipefem.org.br/" target='_blank' className={styles.BtnOng}>Saiba Mais</a>
                        </div>
                    </div>
                    <div className={styles.BoxOng}>
                        <div className={styles.BoxLogoOng}>
                        ...
                        <div className={styles.BoxDescriptionOng}>
                            ...
                            <a href="https://cvv.org.br/conheca-mais/" target='_blank' className={styles.BtnOng}>Saiba Mais</a>
                        </div>
                    </div>
                    <div className={styles.BoxOng}>
                        <div className={styles.BoxLogoOng}>
                        ...
                        <div className={styles.BoxDescriptionOng}>
                            ...
                            <a href="https://www.instagram.com/casademariasoficial/" target='_blank' className={styles.BtnOng}>Saiba Mais</a>
                        </div>
                    </div>
                    <div className={styles.BoxOng}>
                        <div className={styles.BoxLogoOng}>
                        ...
                        <div className={styles.BoxDescriptionOng}>
                            ...
                            <a href="https://institutoborboletaazul.org.br/" target='_blank' className={styles.BtnOng}>Saiba Mais</a>
                        </div>
                    </div>
                    <div className={styles.BoxOng}>
                        <div className={styles.BoxLogoOng}>
                        ...
                        <div className={styles.BoxDescriptionOng}>
                            ...
                            <a href="https://www.bemdoestar.org/" target='_blank' className={styles.BtnOng}>Saiba Mais</a>
                        </div>
                    </div>
                    <div className={styles.BoxOng}>
                        <div className={styles.BoxLogoOng}>
                        ...
                        <div className={styles.BoxDescriptionOng}>
                            ...
                            <a href="https://www.ausouvidos.com/" target='_blank' className={styles.BtnOng}>Saiba Mais</a>
                        </div>
                    </div>
