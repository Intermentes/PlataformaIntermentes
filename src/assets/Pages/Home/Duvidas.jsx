...
function Duvidas() {
    return (
        <section className={Styles.section_duvidas}> {/* Usando as classes do CSS Module */}

            <div className={Styles.container_duvidas}> {/* Usando as classes do CSS Module */}
                <h3>Duvidas</h3>
            ...
            <div className={Styles.faq_duvidas}> {/* Usando as classes do CSS Module */}
                <details>
                    <summary>O que é terapia online? <img src={icone} alt="Icone descer" /></summary>
                ...
                <details>
                    <summary>Como funciona a terapia online? <img src={icone} alt="Icone descer" /></summary>
                ...
                <details>
                    <summary>Quais as vantagens da terapia online? <img src={icone} alt="Icone descer" /></summary>
                    <ul>
                ...
                <details>
                    <summary>A terapia online é segura? <img src={icone} alt="Icone descer" /></summary>
                    <p>Sim, a terapia online é segura. Os psicólogos que oferecem atendimento online são obrigados a seguir os mesmos princípios éticos e legais da terapia presencial. As plataformas de terapia online também são seguras e confidenciais.</p>
                </details>
                <details>
                    <summary>Como posso encontrar um psicólogo para fazer terapia online? <img src={icone} alt="Icone descer" /></summary>
                ...
                <p className={Styles.faq_p}> {/* Usando as classes do CSS Module */} Construa pontes para o bem-estar com Intermentes. Atravesse para um futuro mais saudável e resiliente, onde a saúde mental da sua equipe é a base para o sucesso da empresa.</p>
            </div>

            <div className={Styles.importante_duvidas}> {/* Usando as classes do CSS Module */}
                <img src={maos} alt="" />
