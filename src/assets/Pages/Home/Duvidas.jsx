...
function Duvidas() {
    return (
        <section className={Styles.section_duvidas}>
            ...
            <div className={Styles.container_duvidas}>
                <h3>Duvidas</h3>
            ...
            <div className={Styles.faq_duvidas}>
                ...
                <p className={Styles.faq_p}>Construa pontes para o bem-estar com Intermentes. Atravesse para um futuro mais saudável e resiliente, onde a saúde mental da sua equipe é a base para o sucesso da empresa.</p>
            </div>
